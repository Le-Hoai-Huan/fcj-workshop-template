...
- **Person 1 - Auth & User Profile**: Amazon Cognito, AWS WAF, Amazon CloudFront.
- **Person 2 - Rule Engine & Workout Generation**: AWS Lambda (API Handler + Rule Engine), Amazon S3 (frontend hosting).
- **Person 3 - Progress & Async Notification**: Amazon SQS, Lambda Worker, Amazon SNS/SES.
- **Person 4 - Admin Panel & Data**: Lambda Admin API, Amazon DynamoDB, API Gateway.
- **Person 5 (my role) - CI/CD & Monitoring**: AWS CodePipeline, AWS CodeBuild, AWS CloudFormation/SAM, Amazon CloudWatch.
