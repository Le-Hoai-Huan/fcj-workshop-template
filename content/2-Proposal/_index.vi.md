...
- **Người 1 - Auth & User Profile**: Amazon Cognito, AWS WAF, Amazon CloudFront.
- **Người 2 - Rule Engine & Sinh giáo án**: AWS Lambda (API Handler + Rule Engine), Amazon S3 (hosting frontend).
- **Người 3 - Tiến trình & Async Notification**: Amazon SQS, Lambda Worker, Amazon SNS/SES.
- **Người 4 - Admin Panel & Data**: Lambda Admin API, Amazon DynamoDB, API Gateway.
- **Người 5 (vai trò của tôi) - CI/CD & Monitoring**: AWS CodePipeline, AWS CodeBuild, AWS CloudFormation/SAM, Amazon CloudWatch.
